...
<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" onblur="myFunction()" name="packageprice" id="packageprice" placeholder=" Package Price in Taka" required>
									</div>
								</div>
...
<!-- Bootstrap Core JavaScript -->
  ...
  <script>
    function myFunction() {
        var x = document.getElementById("packageprice");
        if(x.value <=0){
          x.value="";
        } 
    }
